...
class Comment extends amplify_core.Model {
  ...
  const Comment._internal({required this.id, required userId, required shopID, title, required description, required rate, required approved, images, createdAt, updatedAt}): _userId = userId, _shopID = shopID, _title = title, _description = description, _rate = rate, _approved = approved, _images = images, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Comment({String? id, required String userId, required String shopID, String? title, required String description, required CommentRate rate, required bool approved, List<String>? images}) {
  ...
  String toString() {
    ...
    buffer.write("rate=" + (_rate != null ? amplify_core.enumToString(_rate)! : "null") + ", ");
    buffer.write("approved=" + (_approved != null ? _approved!.toString() : "null") + ", ");
  ...
  Comment copyWith({String? userId, String? shopID, String? title, String? description, CommentRate? rate, bool? approved, List<String>? images}) {
    return Comment._internal(
      id: id,
  ...
  Comment.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _rate = amplify_core.enumFromString<CommentRate>(json['rate'], CommentRate.values),
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'userId': _userId, 'shopID': _shopID, 'title': _title, 'description': _description, 'rate': amplify_core.enumToString(_rate), 'approved': _approved, 'images': _images, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
