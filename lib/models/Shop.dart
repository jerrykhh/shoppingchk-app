...
class Shop extends amplify_core.Model {
  ...
  ShopModelIdentifier get modelIdentifier {
    return ShopModelIdentifier(id: id);
  }
  ...
  String toString() {
    ...
    buffer.write("available=" +
        (_available != null ? _available!.toString() : "null") +
        ", ");
  ...
  factory Shop.clone(Shop source) {
    return Shop(
        id: source.id,
        icon: source.icon,
      ...
      : id = json['id'],
        ...
        _Comments = json['Comments'] is List
            ? (json['Comments'] as List)
                ...
                .toList()
            : null,
        _category = amplify_core.enumFromString<StoreCategoryType>(
            json['category'], StoreCategoryType.values),
  ...
  static final amplify_core.QueryModelIdentifier<ShopModelIdentifier>
      MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<ShopModelIdentifier>();
...
class ShopModelIdentifier implements amplify_core.ModelIdentifier<Shop> {
  ...
  const ShopModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is ShopModelIdentifier && id == other.id;
  }
